...
// import { Modal, Portal, Button, TextInput, Checkbox, Text, useTheme } from "react-native-paper";
...
//                 : [...prev, { ...friend, value: 0 }] // Default to "0" instead of ""
//         );
//     };

//     const updateValue = (uid, value) => {
//         setSplitData((prev) =>
//             prev.map((p) => (p.uid === uid ? { ...p, value: Number(value) || 0 } : p)) // Convert to number
//         );
//     };
...
//                 Alert.alert("Total percentage must be exactly 100%");
//                 return;
//             }

//             updatedSplitData = splitData.map(({ uid, value }) => ({
//                 uid,
//                 share: (Number(value) / 100) * Number(totalBillAmount),
//             }));
//         } else {
//             updatedSplitData = splitData.map(({ uid, value }) => ({
//                 uid,
...
//         console.log(`toTalcalc : ${totalCalculatedAmount}`)
//         console.log(`totalBillAmount : ${totalBillAmount}`)
//         if (totalCalculatedAmount !== Number(totalBillAmount)) {
...
//     return (
//         <Portal>
//             <Modal visible={visible} onDismiss={onDismiss} contentContainerStyle={[styles.modalContainer, { backgroundColor: theme.colors.primaryContainer }]}>
//                 <View style={styles.btnContainer}>
//                     <Button mode={splitMethod === "amount" ? "contained" : "outlined"} onPress={() => setSplitMethod("amount")}>
//                         Split by Amount
//                     </Button>
//                     <Button mode={splitMethod === "percentage" ? "contained" : "outlined"} onPress={() => setSplitMethod("percentage")}>
//                         Split by Percentage
//                     </Button>
//                 </View>

//                 <Text style={[styles.label, { color: theme.colors.onPrimaryContainer }]}>
//                     Select Friends & Enter {splitMethod === "amount" ? "Amount" : "Percentage"}
//                 </Text>
...
//                                 value={splitData.find((p) => p.uid === friend.uid)?.value || ""}
...
//                 <Button mode="contained" labelStyle={styles.btnText} onPress={handleSubmit} style={styles.submitButton}>
//                     Submit
//                 </Button>
//             </Modal>
//         </Portal>
