...
//     const { otpSent, isOtpVerified, verificationId, isProfileComplete, isEmailVerified, loading, error } = useSelector(state => state.userAuth)
...
//         try {
//             const result = await dispatch(verifyOTP({ verificationId, otp: enteredOtp })).unwrap();
//             console.log("OTP Verified Result:", result); // ✅ Check updated values
...
//                     <Text style={[styles.text1, { color: theme.colors.primary }]}>Verify your mobile number</Text>
//                     <Text style={[styles.text3, { color: theme.colors.secondary }]}>OTP has been send to {phoneNumber} via sms.</Text>
//                 </View>

//                 <Text style={[styles.label, { color: theme.colors.primary }]}>Enter OTP</Text>
...
//                             <TextInput
//                                 key={index}
//                                 style={[styles.otpInput, { borderColor: theme.colors.secondary }]}
//                                 value={digit}
...
//                 <Button style={styles.submitBtn} labelStyle={styles.buttonText} mode="contained" onPress={() => handleSubmit(otp.join(''))}>
//                     Verify OTP
//                 </Button>

//                 <View style={[styles.bottom]}>
//                     <Text style={[styles.text2, { color: theme.colors.secondary }]}>Didn't receive the OTP?</Text>
//                     <Button labelStyle={styles.buttonText} onPress={handleResend}>Click to resend</Button>
//                 </View>
